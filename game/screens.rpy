...
transform menu_choices_fadein:
    alpha 0.0
    linear 0.25 alpha 1.0

transform menu_dim_fade:
    alpha 0.0
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Start") action [With(dissolve),Start()]
...
##
## A screen to select which available language the user wants.
